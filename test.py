...
url = 'http://localhost:38148/plexjson'
# url = 'http://therealpickle.net:38148/plexjson'
...
req = urllib2.Request(url, jd, {'Content-Type': 'application/json', 'Content-Length': jdlen})
